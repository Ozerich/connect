...
urlpatterns = patterns('main.views',
    ...
    (r'^community/(?P<id>\d+)/addfile$', 'community_addfile'),
    (r'^community/(?P<id>\d+)/addevent$', 'community_addevent'),
    (r'^community/join/(?P<id>\d+)$', 'community_join'),
    (r'^community/leave/(?P<id>\d+)$', 'community_leave'),
    (r'^community/addfile/(?P<c_id>\d+)/(?P<f_id>\d+)$', 'community_addfile'),
    (r'^topic/(?P<id>\d+)$', 'topic'),
    (r'^topic/reply$', 'topic_reply'),
    (r'^files$', 'files'),
    (r'^change_status$', 'change_status'),
    (r'^files/add$', 'file_add'),
